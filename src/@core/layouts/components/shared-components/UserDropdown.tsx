  ...
  return (
    <Fragment>
      ...
      >
        <Box sx={{ pt: 2, pb: 3, px: 4 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Badge
              ...
              anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
            >
              <Avatar alt={`${user?.first_name} ${user?.last_name}`} src={user?.avatar ?? '/images/avatars/1.png'} sx={{ width: '2.5rem', height: '2.5rem' }} />
            </Badge>
        ...
        <MenuItem sx={{ p: 0 }} onClick={() => { handleDropdownClose(); router.push('/account-settings') }}>
          <Box sx={styles}>
